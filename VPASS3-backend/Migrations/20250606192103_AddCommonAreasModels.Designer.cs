...
namespace VPASS3_backend.Migrations
{
    ...
    [Migration("20250606192103_AddCommonAreasModels")]
    partial class AddCommonAreasModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VPASS3_backend.Models.CommonAreas.ReservableCommonArea.CommonAreaReservation", b =>
                {
                    ...
                    b.Property<int>("IdVisitorReservedBy")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VPASS3_backend.Models.CommonAreas.UsableCommonArea.UtilizationUsableCommonAreaLog", b =>
                {
                    ...
                    b.Property<int>("IdUtilizationUsableCommonAreaLog")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdUtilizationUsableCommonAreaLog");
            ...
            modelBuilder.Entity("VPASS3_backend.Models.CommonAreas.ReservableCommonArea.ReservableCommonArea", b =>
                {
                    ...
                    b.Property<TimeSpan?>("MaxReservationTime")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("VPASS3_backend.Models.CommonAreas.ReservableCommonArea.CommonAreaReservation", b =>
                {
                    b.HasOne("VPASS3_backend.Models.CommonAreas.ReservableCommonArea.ReservableCommonArea", "CommonArea")
                        .WithMany("Reservations")
                        .HasForeignKey("IdReservableCommonArea")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VPASS3_backend.Models.Visitor", "ReservedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("VPASS3_backend.Models.CommonAreas.ReservableCommonArea.ReservationCommonAreaGuest", b =>
                {
                    b.HasOne("VPASS3_backend.Models.CommonAreas.ReservableCommonArea.CommonAreaReservation", "Reservation")
                        .WithMany("Guests")
            ...
            modelBuilder.Entity("VPASS3_backend.Models.CommonAreas.UsableCommonArea.UtilizationUsableCommonAreaLog", b =>
                {
                    b.HasOne("VPASS3_backend.Models.CommonAreas.UsableCommonArea.UsableCommonArea", "CommonArea")
                        .WithMany("UtilizationUsableCommonAreaLog")
                        .HasForeignKey("IdUtilizationUsableCommonAreaLog")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VPASS3_backend.Models.CommonAreas.UsableCommonArea.UsableCommonArea", b =>
                {
                    b.Navigation("UtilizationUsableCommonAreaLog");
                });

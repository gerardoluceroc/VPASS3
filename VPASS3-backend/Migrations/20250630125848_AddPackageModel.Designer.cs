...
namespace VPASS3_backend.Migrations
{
    ...
    [Migration("20250630125848_AddPackageModel")]
    partial class AddPackageModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VPASS3_backend.Models.Apartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VPASS3_backend.Models.ApartmentOwnership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VPASS3_backend.Models.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IdApartmentOwnership")
                        .HasColumnType("int");

                    b.Property<int?>("IdPersonWhoReceived")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdApartmentOwnership");

                    b.HasIndex("IdPersonWhoReceived");
            ...
            modelBuilder.Entity("VPASS3_backend.Models.ApartmentOwnership", b =>
                {
                    b.HasOne("VPASS3_backend.Models.Apartment", "Apartment")
                        .WithMany("Ownerships")
            ...
            modelBuilder.Entity("VPASS3_backend.Models.CommonAreas.CommonAreaReservation", b =>
                {
                    b.HasOne("VPASS3_backend.Models.CommonAreas.CommonArea", "CommonArea")
                        .WithMany("Reservations")
                        .HasForeignKey("IdCommonArea")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("VPASS3_backend.Models.Person", null)
                        .WithMany("InvitedCommonAreaReservations")
            ...
            modelBuilder.Entity("VPASS3_backend.Models.Package", b =>
                {
                    ...
                    b.HasOne("VPASS3_backend.Models.ApartmentOwnership", "Ownership")
                        .WithMany()
                        .HasForeignKey("IdApartmentOwnership")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VPASS3_backend.Models.Person", "Receiver")
                        .WithMany()
                        .HasForeignKey("IdPersonWhoReceived");
